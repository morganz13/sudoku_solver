...
class Sudoku:
    ...
    def nextChoiceWeights_3(self, _factor):  # heuristically, the least used digit across the board
        ...
        for id in range(81):
            ...
            if self.getCell(id) != 0:
                ...
                self.digit_heuristic[self.getCell(id)] += 1
    ...
    def solve(self, _nextCellMethod, _nextChoiceMethod, _start_time, _prefillSingleChoiceCells = False):
        ...
        if _prefillSingleChoiceCells is True:
...
while True:
    print("Would you like to input your own puzzel or have an example? [1/2/Q (Quit)]")
    inp = input("> ")
        ...
        if int(inp) == 1:
            ...
            for i in range(9):
                ...
                for j in range(9):
                    ...
                    # Print the first dimension of the two dimensional array
                    for m, k in enumerate(base):
                            ...
                            for l, x in enumerate(k):
                                ...
                                if l == j:
                                    ...
                                    if (l + 1) % 3 == 0:
                                        ...
                                        print(Fore.RED + str(x) + Fore.RESET, end = " | ")
                    ...
                    while _tmp:
                        ...
                        inp = input("Number (0/ENT for blank): ")

                        try:
                            if int(inp) > 9 or int(inp) < 0:

                                raise ValueError  # Exit try statement

                            base[i][j] = int(inp)
                            _tmp = False  # Stop the repeat

                        except ValueError:

                            if inp == "":  # Allow <enter> as a secondary to '0'
                                base[i][j] = 0
                                _tmp = False  # Stop the repeat
                                break
            ...
            # Initialize the class to a SLI port
            mySudoku = Sudoku(base)
            start = time.time()
